// =============================== MAIN CATEGORIES ===============================
const main = [
  { korname: '로고&아이덴티티', engname: 'logos' },
  { korname: '웹&앱 디자인', engname: 'webs' },
  { korname: '비즈니스&광고', engname: 'business' },
  { korname: '아트&일러스트', engname: 'arts' },
  { korname: '패키지&라벨', engname: 'packages' },
  { korname: '북&매거진', engname: 'books' },
];
...
module.exports = {
  main, logos, webs, business, arts, packages, books, errors,
};
